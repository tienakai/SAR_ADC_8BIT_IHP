...
set ::env(RCX_RULESETS) "\"nom_*\" /opt/pdks/ihp-sg13g2/libs.tech/librelane/IHP_rcx_patterns.rules"
...
set ::env(RCX_LEF) /opt/pdks/ihp-sg13g2/libs.ref/sg13g2_stdcell/lef/sg13g2_tech.lef
set ::env(RCX_RULESET) /opt/pdks/ihp-sg13g2/libs.tech/librelane/IHP_rcx_patterns.rules
set ::env(SAVE_SPEF) /home/designer/shared/SAR_ADC_8BIT_IHP/librelane/sar_algo/runs/RUN_2026-04-03_07-12-32/54-openroad-rcx/nom/sar_algo.nom.spef
