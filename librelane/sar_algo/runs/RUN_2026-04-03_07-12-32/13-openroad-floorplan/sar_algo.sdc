...
set_input_delay 12.5000 -clock [get_clocks {fclk_in}] -add_delay [get_ports {VDD}]
set_input_delay 12.5000 -clock [get_clocks {fclk_in}] -add_delay [get_ports {VSS}]
...
set_driving_cell -lib_cell sg13g2_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {VDD}]
set_driving_cell -lib_cell sg13g2_buf_4 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {VSS}]
